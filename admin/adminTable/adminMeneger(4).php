...
if($result = $conn->query($sql)){
    ...
    echo "<h2>Таблица услуги</h2>";
    echo "<p>Получено объектов: $rowsCount</p>";
    echo "<table><tr><th>Id</th><th>Услуга</th></tr>";
    foreach($result as $row){
        echo "<tr>";
            echo "<td>" . $row["id"] . "</td>";
            echo "<td>" . $row["title"] . "</td>";
           
                echo "<td><a href='update/update(4).php?id=" . $row["id"] . "'>Изменить</a></td>";
        echo "</tr>";
    }
    echo "</table>";
    $result->free();
...
<form action="create/create(4).php" method="post">
    <p>Услуга:
