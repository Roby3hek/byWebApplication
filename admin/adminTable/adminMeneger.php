...
if($result = $conn->query($sql)){
    ...
    echo "<h2>Таблица клиенты</h2>";
    echo "<p>Получено объектов: $rowsCount</p>";
    echo "<table><tr><th>Id</th><th>Фамилия</th><th>Имя</th><th>Почта</th><th>Пароль</th></tr>";
    foreach($result as $row){
        echo "<tr>";
            ...
            echo "<td><form action='delete/delete.php' method='post'>
                        <input type='hidden' name='id' value='" . $row["id"] . "' />
                        <input type='submit' value='Удалить'>
                </form></td>";
                echo "<td><a href='update/update.php?id=" . $row["id"] . "'>Изменить</a></td>";
        echo "</tr>";
    }
    echo "</table>";
    $result->free();
