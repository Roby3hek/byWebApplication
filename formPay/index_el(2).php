...
if (isset($_POST['fio']) && isset($_POST['adress'])&& isset($_POST['number'])&& isset($_POST['promo'])){
    ...
    if ($result && $promo == 'reg10el') {
    	echo "Заказ успешно оформлен, стоимость <br> с учетом промокода составляет 6300 рублей, <br> ожидайте звонка менеджера";
    } 
    else if ($result){
        echo "Заказ успешно оформлен, стоимость <br> составляет 7000 рублей, ожидайте <br> звонка менеджера";
    }
}?>
<!DOCTYPE html>
<html lang="ru">
